...
#define SWIG_name    "Ws2812"

static VALUE mWs2812;
...
extern "C"
#endif
SWIGEXPORT void Init_ws2812(void) {
  size_t i;
  
  SWIG_InitRuntime();
  mWs2812 = rb_define_module("Ws2812");
  ...
  SwigClassColor_t.klass = rb_define_class_under(mWs2812, "Color_t", rb_cObject);
  ...
  rb_define_module_function(mWs2812, "init", _wrap_init, -1);
  rb_define_module_function(mWs2812, "clear", _wrap_clear, -1);
  rb_define_module_function(mWs2812, "show", _wrap_show, -1);
  rb_define_module_function(mWs2812, "Wheel", _wrap_Wheel, -1);
  rb_define_module_function(mWs2812, "colorWipe", _wrap_colorWipe, -1);
  rb_define_module_function(mWs2812, "rainbow", _wrap_rainbow, -1);
  rb_define_module_function(mWs2812, "rainbowCycle", _wrap_rainbowCycle, -1);
  rb_define_module_function(mWs2812, "theaterChase", _wrap_theaterChase, -1);
  rb_define_module_function(mWs2812, "theaterChaseRainbow", _wrap_theaterChaseRainbow, -1);
  rb_define_module_function(mWs2812, "setBrightness", _wrap_setBrightness, -1);
  rb_define_module_function(mWs2812, "getBrightness", _wrap_getBrightness, -1);
  rb_define_module_function(mWs2812, "RGB2Color", _wrap_RGB2Color, -1);
  rb_define_module_function(mWs2812, "Color", _wrap_Color, -1);
  rb_define_module_function(mWs2812, "setPixelColor", _wrap_setPixelColor, -1);
  rb_define_module_function(mWs2812, "setPixelColorT", _wrap_setPixelColorT, -1);
  rb_define_module_function(mWs2812, "getPixelColor", _wrap_getPixelColor, -1);
  rb_define_module_function(mWs2812, "numPixels", _wrap_numPixels, -1);
  rb_define_module_function(mWs2812, "getPixels", _wrap_getPixels, -1);
  rb_define_module_function(mWs2812, "setPWMBit", _wrap_setPWMBit, -1);
  rb_define_module_function(mWs2812, "getPWMBit", _wrap_getPWMBit, -1);
  rb_define_module_function(mWs2812, "dumpLEDBuffer", _wrap_dumpLEDBuffer, -1);
  rb_define_module_function(mWs2812, "dumpPWMBuffer", _wrap_dumpPWMBuffer, -1);
  rb_define_module_function(mWs2812, "dumpPWMStatus", _wrap_dumpPWMStatus, -1);
  rb_define_module_function(mWs2812, "dumpPWMControl", _wrap_dumpPWMControl, -1);
  rb_define_module_function(mWs2812, "dumpPWMDMAC", _wrap_dumpPWMDMAC, -1);
  rb_define_module_function(mWs2812, "dumpPWM", _wrap_dumpPWM, -1);
  rb_define_module_function(mWs2812, "dumpDMARegs", _wrap_dumpDMARegs, -1);
  rb_define_module_function(mWs2812, "dumpControlBlock", _wrap_dumpControlBlock, -1);
  rb_define_module_function(mWs2812, "dumpTransferInformation", _wrap_dumpTransferInformation, -1);
  rb_define_module_function(mWs2812, "dumpDMA", _wrap_dumpDMA, -1);
  rb_define_module_function(mWs2812, "terminate", _wrap_terminate, -1);
}
